...
class Project extends CI_Controller {
    ...
    public function index()
	{
		...
		$this->load->view('common/footer_view2');
    ...
    public function about()
	{
		...
		$this->load->view('common/header_view2');
		$this->load->view('Project/About_view');
		$this->load->view('common/footer_view2');
	}
    public function categories()
	{
		...
		$this->load->view('common/header_view2');
		$this->load->view('Project/Categories_view');
		$this->load->view('common/footer_view2');
	}
    public function events()
	{
		...
		$this->load->view('common/header_view2');
		$this->load->view('Project/Events_view');
		$this->load->view('common/footer_view2');
	}
    public function contact_us()
	{
		...
		$this->load->view('common/header_view2');
		$this->load->view('Project/Contact_us_view');
		$this->load->view('common/footer_view2');
	}
